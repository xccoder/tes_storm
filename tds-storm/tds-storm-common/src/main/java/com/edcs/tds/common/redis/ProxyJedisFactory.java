...
public class ProxyJedisFactory implements PooledObjectFactory<Jedis> {
	...
	public ProxyJedisFactory(final List<String> addressList, final int timeout, final String password, final int database) {
		this(addressList, timeout, password, database, null);
	}

	public ProxyJedisFactory(final List<String> addressList, final int timeout, final String password, final int database, final String clientName) {
	...
	public PooledObject<Jedis> makeObject() throws Exception {
		...
		logger.info("makeObject Jedis host: {}, port: {}, timeout {}.", new Object[] { hostAndPort.getHost(), hostAndPort.getPort(), timeout });
